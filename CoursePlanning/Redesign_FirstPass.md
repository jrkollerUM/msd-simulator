...
1. **Pre-work carries derivations and motivation.** Each session has a paired 15–20 min video that handles (a) the *why*, (b) the key derivation steps, and (c) one worked example. Students arrive primed.
